...
- **采集**：2026-09-20T09:55:17+08:00　|　**id**：`cd2acb9852fafe73`
...
549 条建议，每条写明花掉什么、换回什么、证据有多硬，来源只引期刊论文和官方文件。
...
[![条目](https://img.shields.io/badge/%E6%9D%A1%E7%9B%AE-549%20%E6%9D%A1-18794e?style=flat-square)](#目录)
[![证据分级](https://img.shields.io/badge/%E8%AF%81%E6%8D%AE%E5%88%86%E7%BA%A7-A%20363%20%C2%B7%20B%20136%20%C2%B7%20C%2050-915930?style=flat-square)](#证据分级)
[![原始文献](https://img.shields.io/badge/%E5%8E%9F%E5%A7%8B%E6%96%87%E7%8C%AE-1129%20%E6%9D%A1%E9%93%BE%E6%8E%A5-565a5f?style=flat-square)](docs/核实记录/)
...
- **条目之间会互相指路**（「见第 8 节第 16 条」这种）：在检索页里这些引用带虚线、可以点开，就地显示那一条的标题和「说人话」，想过去再按「跳过去」，目标被筛选藏起来时会自动把筛选清掉。在 GitHub 上直接读正文时点不了，但每处引用后面都带着它指向什么（「见第 16 条（借钱写清借条）」），不用翻过去也知道说的是哪条。
...
- **只想看结论最硬的**：在检索页里勾选证据等级 A，只留下有具体数字、来自荟萃分析或大型试验的 363 条。
- **只想看最值得做的**：勾选性价比「极高」，得到 102 条既不花钱、不花时间、不需要毅力，收益又落在最大一档的条目。再叠加一个「换回什么」，就是该口径下的优先清单。
...
全书 549 条中 A 级 363 条、B 级 136 条、C 级 50 条，另有 48 条标注了争议、38 处标注了 TODO 待核实。有争议的 A/B 级条目会标注「争议」并列出反方证据。所有来源只引原始文献（期刊论文附 DOI 或 PubMed 链接，或 WHO/CDC/国家统计局等官方机构报告），不引二手转述。不确定的数字标「待核实」。
...
全书 549 条中性价比极高 102 条（19%）、高 261 条（48%）、一般 186 条（34%）。中间一档偏厚是有意的：底层的收益量级只有三级判断，再往下切就是假装精度。
...
- https://img.shields.io/badge/%E5%8E%9F%E5%A7%8B%E6%96%87%E7%8C%AE-1129%20%E6%9D%A1%E9%93%BE%E6%8E%A5-565a5f?style=flat-square
...
- https://img.shields.io/badge/%E6%9D%A1%E7%9B%AE-549%20%E6%9D%A1-18794e?style=flat-square
- https://img.shields.io/badge/%E8%AE%B8%E5%8F%AF-Unlicense-565a5f?style=flat-square
- https://img.shields.io/badge/%E8%AF%81%E6%8D%AE%E5%88%86%E7%BA%A7-A%20363%20%C2%B7%20B%20136%20%C2%B7%20C%2050-915930?style=flat-square
