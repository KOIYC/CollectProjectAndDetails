---
type: "corpus"
item_id: "d6565a75997045bd"
title: "我开源了一个极简 Agent 框架，叫 Kiso。「V 站首发」"
source: "v2ex"
source_name: "V2EX"
url: "https://www.v2ex.com/t/1243519"
author: "langlang280025"
published_at: "2026-09-21T00:57:14"
...
> [!meta]- 语料信息（点开展开）
> 来源：V2EX（post）
> 原帖：<https://www.v2ex.com/t/1243519>
> 指标：回复=0
> 作者：langlang280025　|　发布：2026-09-21T00:57:14
> 项目链接：—
> 采集：2026-09-21T09:48:10+08:00　|　id：`d6565a75997045bd`
...
这不是命名洁癖。Kiso 不希望模型继承用户完整的交互式 Shell 环境，而是通过系统 Shell 执行命令，工作目录绑定在项目 Workspace ，并且对子进程环境变量进行清洗。Kiso 自身使用的 API Key 、Token 不应该因为模型执行一次 `env` 或 `printenv`，就跟着整个环境一起被吐回 Context 。
...
Kiso 当前 CLI 对外提供五种主要运行模式：`default`、`accept-edits`、`plan`、`dontAsk` 和 `bypass`。
