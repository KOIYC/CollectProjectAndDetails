---
type: "corpus"
item_id: "a00f21172a67d634"
title: "SamMintah/openstartups"
source: "github_new"
source_name: "GitHub 新星仓库"
url: "https://github.com/SamMintah/openstartups"
project_url: "https://sammintah.github.io/openstartups"
author: "SamMintah"
published_at: "2026-06-14T22:14:52Z"
...
# SamMintah/openstartups

> [!info] 一句话导读
> Open database of profitable startups with complete replication playbooks, business models, tech stacks, and step-by-step guides. Learn from real verified MRR co…

> [!meta]- 语料信息（点开展开）
> 来源：GitHub 新星仓库（post）
> 原帖：<https://github.com/SamMintah/openstartups>
> 指标：stars=0 · forks=0 · open_issues=0
> 作者：SamMintah　|　发布：2026-06-14T22:14:52Z
> 项目链接：<https://sammintah.github.io/openstartups>
> 采集：2026-09-20T09:36:32+08:00　|　id：`a00f21172a67d634`
...
A free, community-driven collection of **real profitable startups** with detailed replication playbooks. Each entry includes:
...
2. **Read** the `index.md` for an overview
3. **Study** the `business-model.md` for pricing and revenue strategy
4. **Follow** the `replication-guide.md` to build your own version
5. **Check** `metrics.json` for structured data

## How to Contribute

We welcome contributions! See [CONTRIBUTING.md](CONTRIBUTING.md) for:

- How to add a new startup entry
...
- **Respect intellectual property** and trademarks
- **Do your own validation** — metrics may change over time
- **Build your own version** — don't copy code or branding
- **Check legal requirements** in your jurisdiction

We are not affiliated with any startup listed here. All trademarks belong to their respective owners.

## Topics

`startups` `indie-hackers` `bootstrapping` `saas` `micro-saas` `replication-playbooks` `business-models` `open-source` `entrepreneurship` `mrr` `passive-income`
...
- https://img.shields.io/badge/data%20sources-verified-orange.svg
- https://img.shields.io/badge/reported%20MRR-%247.9M-green.svg
- https://img.shields.io/badge/startups-34-blue.svg
- https://opensource.org/licenses/MIT
- https://trustmrr.com

## 导航

- 项目页：[[10-项目/sammintah.github.io_e1b639cd]]
