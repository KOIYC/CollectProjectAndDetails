---
type: "corpus"
item_id: "93eb5671d414dfe3"
title: "Show HN: Four-Leaf MCP, open-source job search and interview prep"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49791084"
project_url: "https://github.com/fourleafai/clover-public"
author: "frank_clover"
published_at: "2026-09-21T18:13:11Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49791084>
> 指标：点赞=3 · 评论=0 · engagement_velocity=3
> 作者：frank_clover　|　发布：2026-09-21T18:13:11Z
> 项目链接：<https://github.com/fourleafai/clover-public>
> 采集：2026-09-25T00:12:57+08:00　|　id：`93eb5671d414dfe3`

## 正文

# fourleafai/clover-public

Open-source Claude Skill + MCP integration for job search and interview prep. Live job data, role-specific interview intel, voice mock interviews on four-leaf.ai.
...
- Open issues: 0
- License: MIT License
- Homepage: https://four-leaf.ai
- Default branch: main
- Created: 2026-05-22T21:07:38Z
...
- `--tool ` pick the tool yourself: `claude-code`, `cursor`, `codex`, or `github-copilot`
...
If you'd rather not run `npx` (air-gapped network, or you just want to see what lands where), clone and build the bundles yourself. This is exactly what `npx four-leaf-coach add --tool ` automates.
...
`npm run build` reads `skills/four-leaf-coach/SKILL.md` plus the adjacent `references/` tree and writes a `dist/ /` directory for each supported tool. Then copy your tool's bundle into place:
...
- https://four-leaf.ai/api/mcp`
- https://github.com/fourleafai/clover-public.git

## 导航

- 项目页：[[10-项目/github.com_2afa8371]]
- 渠道页：[[50-渠道/hn_show]]
