...
author: "conikeec"
published_at: "2026-08-30T15:01:49Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49499265>
> 指标：点赞=3 · 评论=1 · engagement_velocity=3
> 作者：conikeec　|　发布：2026-08-30T15:01:49Z
> 项目链接：<https://github.com/modiqo/spewer>
> 采集：2026-09-21T03:11:31+08:00　|　id：`177900dd69707036`
...
- Homepage: https://modiqo.github.io/spewer/
- Default branch: main
- Created: 2026-08-29T05:56:59Z
...
A frontier harness delegates bounded work through Spewer to a commodity model
...
tool output, and secrets. Use `spewer tail ` for the complete machine-readable event log.
...
a durable task handle. `spewer capsule show ` reports these choices for any installed capsule.
...
A harness adapter stores its continuation while Spewer executes and returns a receipt
...
- How Spewer works explains the product, every component, and both complete
 user flows.
- Task protocol defines requests, events, receipts, and delivery.
- Durability and crash closure explain restart
 behavior.
- Security defines permissions, approvals, and side-effect boundaries.
- Frontier integration defines the small harness client.
- Play integration defines the first complete durable parent
 adapter.
- Design index links every accepted contract and decision.
- Checkpoint evidence records passed proof through CP25.
...
Error fetching https://nohtml.felixs.eu: unknown error
Error fetching https://twitter.com/oblomovius/status/2094053464552698325: SOURCE_NOT_AVAILABLE

## 评论（1/1）

> **conikeec** · 2026-08-30T15:03:39.000Z　
> Longer explanation: https://modiqo.github.io/spewer/For the past few months, we have been using an internal tool to send simpler work from Codex (sol xhigh) to cheaper models (Luna, Qwen). We called it delegate, which described the function but never felt like a real name.
> Tidy'd it up and released it as Spewer.I hope any you find it useful as we did.

## 关联链接

- https://modiqo.github.io/spewer/
- https://nohtml.felixs.eu:
- https://twitter.com/oblomovius/status/2094053464552698325:

## 导航

- 项目页：[[10-项目/github.com_4e101e3a]]
- 渠道页：[[50-渠道/hn_show]]
