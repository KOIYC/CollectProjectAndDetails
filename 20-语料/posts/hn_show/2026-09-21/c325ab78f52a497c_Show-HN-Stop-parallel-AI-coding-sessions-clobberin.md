...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=48325871>
> 指标：点赞=2 · 评论=0 · engagement_velocity=2
> 作者：nahsuhn　|　发布：2026-05-29T16:54:22Z
> 项目链接：<https://github.com/joshduffy/claude-handoff-guard>
> 采集：2026-09-21T02:52:58+08:00　|　id：`c325ab78f52a497c`
...
`~/.claude/projects/ /memory/handoff- -.md`, where ` ` is the
...
once per session. The escape hatches (`touch /tmp/handoff-guard-bypass- `, or
...
- The ` ` token in a filename is not checked against the real branch (intentional: cross-device
