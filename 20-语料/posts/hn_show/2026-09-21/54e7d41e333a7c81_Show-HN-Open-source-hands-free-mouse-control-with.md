---
type: "corpus"
item_id: "54e7d41e333a7c81"
title: "Show HN: Open-source hands-free mouse control with Tracky Mouse"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49504106"
project_url: "https://github.com/1j01/tracky-mouse"
author: "1j01"
published_at: "2026-08-31T00:00:10Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49504106>
> 指标：点赞=2 · 评论=0 · engagement_velocity=2
> 作者：1j01　|　发布：2026-08-31T00:00:10Z
> 项目链接：<https://github.com/1j01/tracky-mouse>
> 采集：2026-09-21T03:11:27+08:00　|　id：`54e7d41e333a7c81`
...
- If the camera can't be accessed at all, make sure it's not being used by another application, then click "Allow Camera Access" in the app. Also try unplugging the camera and plugging it in again (if it's an external camera), or restarting your computer.
 - On Linux: Installing (and maybe running?) `guvcview` can magically fix a webcam not showing up. (source)
...
- facemesh and TensorFlow.js for accurate face tracking (once this loads, it stops using clmtrackr.js)
 - tfjs-models: Apache License 2.0
...
- Install Node.js if you don't have it
 - Recommended: install via nvm or nvm-windows
 - The supported Node.js version is specified in `.nvmrc`
...
- For macOS:
 ...
 - Tested with Xcode 10.3. Old versions of Xcode can be downloaded from xcodereleases.com
...
Sound effects:
- Sleep gesture pause/unpause: Michel Baradari - 9 Sci-Fi Computer Sounds and Beeps (CC-BY 3.0)
- Click: Kenney - 51 UI sound effects (buttons, switches and clicks) (CC0)
- Middle click: Isaiah Odhner - Middle Mouse Click (CC0)
