---
type: "corpus"
item_id: "fe8fc298908ca716"
title: "Show HN: stock-tui – an open-source terminal app inspired by StockTouch"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49110923"
project_url: "https://github.com/chatcode-lab/stock-tui"
author: "borkasm"
published_at: "2026-07-30T14:52:53Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49110923>
> 指标：点赞=4 · 评论=0 · engagement_velocity=4
> 作者：borkasm　|　发布：2026-07-30T14:52:53Z
> 项目链接：<https://github.com/chatcode-lab/stock-tui>
> 采集：2026-09-21T03:11:16+08:00　|　id：`fe8fc298908ca716`

## 正文

# chatcode-lab/stock-tui

Mouse-first terminal stock market heatmap inspired by StockTouch, built with Rust and Ratatui in https://chatcode.dev.
...
- Open issues: 1
- License: MIT License
- Homepage: https://chatcode.dev/lab/stock-tui
- Default branch: main
- Created: 2026-07-13T21:53:27Z
...
Nine-sector stock market heatmap in stock-tui
...
Technology sector top-100 heatmap in stock-tui
...
NVDA detail view with price and volume charts in stock-tui
...
Data Providers before selecting `sip` or
...
Stock API HTTP Contract before operating a
...
| --- | --- |
| Linux x86_64 | `stock-tui-v -x86_64-unknown-linux-musl.tar.gz` |
| Linux ARM64 | `stock-tui-v -aarch64-unknown-linux-musl.tar.gz` |
| macOS Apple Silicon | `stock-tui-v -aarch64-apple-darwin.tar.gz` |
| macOS Intel | `stock-tui-v -x86_64-apple-darwin.tar.gz` |
| Windows x86_64 | `stock-tui-v -x86_64-pc-windows-msvc.zip` |
...
`data/sec_share_policies.json`. The builder
...
See Requesting Public-Display Permission
before proposing any no-key service.

See Cache and Sync for the schema and lifecycle, and
Configuration for every supported option.
...
See CONTRIBUTING.md before proposing a new data source or
...
The source code is available under the MIT License. That license
applies to this project's code and documentation, not to third-party market
data, news, trademarks, or provider content.

# Show HN: Touchgrass, non-addictive social network, Fediverse and bsky-compatible | Hacker News

## 关联链接

- http://127.0.0.1:8787
- https://chatcode.dev.
- https://chatcode.dev/lab/stock-tui
- https://github.com/chatcode-lab/stock-tui.git
- https://stock.chatcode.dev/api
- https://stock.chatcode.dev/catalog/sec-catalog.json`.

## 导航

- 项目页：[[10-项目/github.com_9a9a4cdc]]
- 渠道页：[[50-渠道/hn_show]]
