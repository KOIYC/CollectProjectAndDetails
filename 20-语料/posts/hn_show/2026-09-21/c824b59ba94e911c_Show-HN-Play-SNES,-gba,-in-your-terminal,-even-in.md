---
type: "corpus"
item_id: "c824b59ba94e911c"
title: "Show HN: Play SNES, gba, in your terminal, even in tmux"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49117254"
project_url: "https://github.com/jhickner/rom"
author: "jhickner"
published_at: "2026-07-30T23:39:33Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49117254>
> 指标：点赞=6 · 评论=0 · engagement_velocity=6
> 作者：jhickner　|　发布：2026-07-30T23:39:33Z
> 项目链接：<https://github.com/jhickner/rom>
> 采集：2026-09-21T03:11:11+08:00　|　id：`c824b59ba94e911c`
...
Metroid Fusion running inline in the terminal with hue recoloring
...
— see tmux for the one setting that needs.
...
Use `--core ` to select one directly.
...
| `--core ` | Use a specific core |
| `--fullscreen` | Fill the terminal window |
| `--scale ` | Integer zoom in inline mode, 1–8 (default 2); change live with `[` / `]` |
| `--slot ` | Initial save-state slot, 0–9 |
| `--no-audio` | Disable audio |
| `--recolor ` | `off`, `hue`, `nearest`, `duotone`, or `dither` |
| `--recolor-strength <0..1>` | Blend recoloring with the original |
| `--keys` | Print current key bindings |
| `--selftest ` | Run `n` frames without a terminal |
| `--shot ` | Save the final self-test frame as BMP |
...
`rom --keys ` to see the effective settings.
