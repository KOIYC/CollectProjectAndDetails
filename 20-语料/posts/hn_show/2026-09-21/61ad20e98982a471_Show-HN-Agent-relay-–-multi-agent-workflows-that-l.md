---
type: "corpus"
item_id: "61ad20e98982a471"
title: "Show HN: Agent-relay – multi-agent workflows that learn from past runs"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=47963653"
project_url: "https://github.com/srijansk/agent-relay"
author: "srijanskt"
published_at: "2026-04-30T15:06:57Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=47963653>
> 指标：点赞=2 · 评论=0 · engagement_velocity=2
> 作者：srijanskt　|　发布：2026-04-30T15:06:57Z
> 项目链接：<https://github.com/srijansk/agent-relay>
> 采集：2026-09-21T02:52:23+08:00　|　id：`61ad20e98982a471`
...
`docs/demo-output/` against `gpt-4o`:
...
That's the receipts. See `docs/demo-output/README.md`
...
A no-API-key walkthrough lives at `docs/DEMO.md`.
...
`.relay/history/ /` for `relay distill` to read.

## Templates (v0.2)

| Template | What it's for |
|---|---|
| `bug-rca-fix` | 5-stage bug fix: reproduce → hypothesise → plan → review → implement → verify. Highest signal for the lessons loop because reviewer rejections and auditor catches are exactly what compounds. |
| `rfc-then-implement` | Design-then-build: RFC → review → implement → audit. Useful for changes that need explicit alternatives + rollback before code is written. |
| `plan-review-implement-audit` | The classic 4-role loop. Generic enough for most non-trivial features. |
...
`docs/specs/2026-04-28-v0.2-design.md`
...
- https://github.com/srijansk/agent-relay.git

## 导航

- 项目页：[[10-项目/github.com_579313cd]]
- 渠道页：[[50-渠道/hn_show]]
