...
published_at: "2026-08-30T17:04:03Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49500488>
> 指标：点赞=2 · 评论=0 · engagement_velocity=2
> 作者：lebagetdefrance　|　发布：2026-08-30T17:04:03Z
> 项目链接：<https://github.com/doofzoff/SIMURG>
> 采集：2026-09-21T03:11:29+08:00　|　id：`07349f7ec8b0677c`

## 正文

# doofzoff/SIMURG

Zero-leak online detection of LLM decoding corruption — catch repetition loops, language drift and garbage mid-stream, before the user sees a bad token. Works with any OpenAI-compatible API.
...
1. The problem
2. Paper
3. How SIMURG differs
4. How it works
5. Zero-leak in action
6. Benchmark
7. Install
8. Quick start
9. Teach it your domain and your failure modes
10. Live guard dashboard
11. What SIMURG is NOT
...
| **template leakage** | `<|im_start|>`, ` `, `[INST]`, "As an AI language model..." spilling into the answer |

This is **not** factual hallucination. A fluent-but-wrong sentence (see
What SIMURG is NOT) has no statistical scar. What is shown
...
zero-leak demo: corruption score stays flat, crosses the calibrated threshold, abort and retry
...
detection recall per failure class, and the latency distribution past onset

learned feature weights: the 15-weight online logistic model after calibration
...
**Apache-2.0**. See LICENSE. Developed by **doofZ (Farid Aghayev)**,
HAL-X AI.
...
- https://github.com/doofzoff/SIMURG.git
- https://github.com/doofzoff/SIMURG},
- https://openrouter.ai/api/v1

## 导航

- 项目页：[[10-项目/github.com_599bc54a]]
- 渠道页：[[50-渠道/hn_show]]
