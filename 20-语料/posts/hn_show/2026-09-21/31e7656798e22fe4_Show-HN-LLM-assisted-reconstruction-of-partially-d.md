---
type: "corpus"
item_id: "31e7656798e22fe4"
title: "Show HN: LLM-assisted reconstruction of partially decompiled Minecraft 26.1.2"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=47945593"
project_url: "https://github.com/stevefan1999-personal/demcstify"
author: "stevefan1999"
published_at: "2026-04-29T08:28:32Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=47945593>
> 指标：点赞=8 · 评论=0 · engagement_velocity=8
> 作者：stevefan1999　|　发布：2026-04-29T08:28:32Z
> 项目链接：<https://github.com/stevefan1999-personal/demcstify>
> 采集：2026-09-21T02:52:40+08:00　|　id：`31e7656798e22fe4`
...
- stevefan1999-personal (2 contributions)
...
Minecraft, Mojang, Mojang Studios, and related game code, assets, names, and marks are property of Mojang Studios and Microsoft. All rights are reserved by Mojang Studios and Microsoft. This project claims no ownership of, license to, or endorsement by those rights holders. See `NOTICE.md`.
...
3. **Route mechanically.** Split decompiled source into `subprojects/ /src/main/java` by package ownership.
...
A larger diagram lives in `docs/architecture/01-llm-decompilation-workflow.md`.
...
See `AGENTS.md` for the binding protocol.
...
- `DESIGN.md` — product/technical design, acceptance criteria, state model, drivers, risks.
- `ARCHITECTURE.md` — repository layout, subproject layering, data flow, build outputs, CI topology.
- `docs/README.md` — full documentation index.
- `docs/design/01-publication-contract.md` — publishable/legal boundary.
- `docs/architecture/01-llm-decompilation-workflow.md` — workflow diagrams.
- `docs/research/01-llm-reconstruction-paradigm.md` — research thesis.
- `docs/research/02-llm-decompilation-workflow.md` — workflow research notes.
- `docs/research/03-compile-diagnostics-and-ast-repairs.md` — compile diagnostics and AST-aware repair notes.
- `docs/adr/0001-toolchain-pin.md` — bootstrap toolchain decision.
...
The lab scaffolding in this repository is licensed under the MIT License. See `LICENSE`.
...
Read `AGENTS.md`, `LLM_CODESTYLES.md`, `DESIGN.md`, and `ARCHITECTURE.md` before opening a PR or running agent workflows.
