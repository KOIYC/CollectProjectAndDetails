---
type: "corpus"
item_id: "ef7e0505f51d4329"
title: "Show HN: Myna – a local AI Chief of Staff that remembers your work"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=48733272"
project_url: "https://github.com/agentflock/myna"
author: "bathlasiddharth"
published_at: "2026-06-30T14:34:36Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=48733272>
> 指标：点赞=5 · 评论=0 · engagement_velocity=5
> 作者：bathlasiddharth　|　发布：2026-06-30T14:34:36Z
> 项目链接：<https://github.com/agentflock/myna>
> 采集：2026-09-21T02:53:03+08:00　|　id：`ef7e0505f51d4329`
...
- bathlasiddharth (348 contributions)
...
AI Chief of Staff for tech professionals — your projects, your team, your meetings, your email, all running locally inside Claude Code.

*Built autonomously by Claude Code, end to end — 12 agents, 31 skills, no vibe-coding. How it was built →*
...
Myna is a Claude Code agent with **31 skills** for the work that fills your week: it preps your meetings, triages your inbox, keeps every project and person up to date, and drafts your replies and status updates — all from prompts you type in plain language. It connects to the tools you already use through MCP, reading from your email, Slack, and calendar, and maintains a local knowledge base of your work as plain markdown: projects, people, meetings, decisions, action items, and history.

Plenty of tools can draft an email or summarize a thread. What sets Myna apart is the context behind every one: it works from that knowledge base instead of a blank slate. Install it once and every session builds on the last — the brief on Sarah this morning already includes the recognition you logged last week and the design review she led on April 9, and the Phoenix risk note you draft today knows the blocker is 20 days old, because Myna wrote it all down when it happened. Its drafts sound like you and reflect what's actually going on.
...
You'll be running your first prompt in about five minutes. Prerequisites and run modes are in Getting started below.
...
The User Guide covers all 31 skills in the order you'd use them, with what each one reads and writes.
...
- **All writes are local.** Every Myna write lands inside one folder, ` /myna/`, on your machine. It never writes anywhere else. The single exception is a *personal* calendar time block — a solo event with no attendees, never an invite — enforced by a hard check before every write.
- **Draft, never send.** Outbound communication is always a file in `Drafts/` that you copy and send yourself. There is no `send_email` skill, no `post_to_slack`, no `create_meeting_with_attendees`. Ask Myna to send something and it refuses, then offers to draft instead. The safety rules are plain markdown you can read for yourself: skills/steering-safety/SKILL.md.
...
- **No personal data in the repo.** Your projects, people, channels, and preferences live in YAML config under ` /myna/_system/config/` — gitignored, and entirely separate from the codebase. You can fork or share the Myna repo without leaking a thing about your work.
...
Everything goes into your **Myna vault** — a folder on your machine, readable in any editor. Obsidian is recommended (the dashboards use Dataview) but optional.
...
For the deeper model, see Architecture.
...
- **Claude Code** — the runtime Myna lives in
- **Obsidian** — recommended for the Dataview dashboards; optional, since every file is plain markdown that opens in any editor
...
| Document | Purpose |
|----------|---------|
| User Guide | Full reference — every skill, config, workflow, troubleshooting |
| A Day With Myna | Realistic workday walkthrough with real prompts |
| Obsidian Setup | Plugin configuration and dashboards |
| Architecture | Runtime model, skill inventory, folder structure |
| Foundations | Vault folder structure and canonical file formats |
| How It Was Built | The Claude Code methodology behind Myna |

## Contributing

Contributing uses that same dev harness — open the repo in Claude Code and Myna helps you design, build, and review the change. Full guide: CONTRIBUTING.md.
...
MIT License. Actively developed; some features may not work exactly as expected yet. Myna runs only when you ask — no scheduled jobs or background watchers yet; automation (scheduled runs, email monitoring) is on the roadmap. Tested with Gmail, Google Calendar, and Slack MCPs.

# olzhasar/mess

## 导航

- 项目页：[[10-项目/github.com_0cf9ca26]]
- 渠道页：[[50-渠道/hn_show]]
