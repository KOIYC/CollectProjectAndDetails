---
type: "corpus"
item_id: "26b3dc6e4478377c"
title: "Show HN: Niimbot Label Printer desktop app with Pretix integration"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=47942358"
project_url: "https://github.com/ooguz/niimbot-printer"
author: "m3rcury"
published_at: "2026-04-28T23:44:34Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=47942358>
> 指标：点赞=3 · 评论=0 · engagement_velocity=3
> 作者：m3rcury　|　发布：2026-04-28T23:44:34Z
> 项目链接：<https://github.com/ooguz/niimbot-printer>
> 采集：2026-09-21T02:52:41+08:00　|　id：`26b3dc6e4478377c`

## 正文

Published: 2026-04-18

# Repository: ooguz/niimbot-printer
...
- Topics: label-printer, niimbot, niimbot-b1, pretix, thermal-printer
- Default branch: main
- Created: 2026-04-18T17:07:23Z
- Last push: 2026-04-29T14:23:38Z
- Contributors: 2 (top: ooguz, mertssmnoglu)
- Releases: 2
- Latest release: v0.2.0 (2026-04-18T22:21:06Z)
...
![GitHub Release](https://img.shields.io/github/v/release/ooguz/niimbot-printer) ![PyPI - Version](https://img.shields.io/pypi/v/niimbot-printer) [![Release AppImage](https://github.com/ooguz/niimbot-printer/actions/workflows/release-appimage.yml/badge.svg)](https://github.com/ooguz/niimbot-printer/actions/workflows/release-appimage.yml)
...
**TLDR Downloads:** GitHub **Releases** include two GNU/Linux **AppImage** builds: `NIIMBOT-Printer- -.AppImage` (standalone, no Pretix support) and `NIIMBOT-Printer- - -pretix.AppImage` (with Pretix support).
...
- Enable **Pretix check-in and badge printing**.
 ...
 - **Organizer slug** — as in `https://…/org/ /`.
...
This produces `dist/NIIMBOT-Printer- -.AppImage` (standalone) and `dist/NIIMBOT-Printer- - -pretix.AppImage` (with Pretix), or leaves a ready-to-use `build/AppDir` if `appimagetool` is not installed.
...
- https://docs.pretix.eu/en/latest/api/resources/checkin.html
- https://docs.pretix.eu/en/latest/api/resources/checkinlists.html
- https://github.com/hairymnstr/niimctl
- https://github.com/ooguz/niimbot-printer/actions/workflows/release-appimage.yml
- https://github.com/ooguz/niimbot-printer/actions/workflows/release-appimage.yml/badge.svg
- https://host/pretix`
- https://img.shields.io/github/v/release/ooguz/niimbot-printer
- https://img.shields.io/pypi/v/niimbot-printer
- https://kayit.oyd.org.tr`
- https://pretix.eu
- https://www.solmatas.com
- https://…/org/

## 导航

- 项目页：[[10-项目/github.com_a95bdc9a]]
- 渠道页：[[50-渠道/hn_show]]
