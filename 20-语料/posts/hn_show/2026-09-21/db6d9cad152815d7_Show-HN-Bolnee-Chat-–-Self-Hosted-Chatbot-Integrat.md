...
project_url: "https://github.com/AniketWathore/bolnee-chat"
author: "AniketWathore"
published_at: "2026-08-30T09:56:05Z"
...
tags:
  - 语料
  - hn_show
  - author_AniketWathore
  - story_49497227
  - show_hn
metrics: {"points": 32, "comments": 0, "engagement_velocity": 32}
comments_count: 0
comments_total: 0
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49497227>
> 指标：点赞=32 · 评论=0 · engagement_velocity=32
> 作者：AniketWathore　|　发布：2026-08-30T09:56:05Z
> 项目链接：<https://github.com/AniketWathore/bolnee-chat>
> 采集：2026-09-21T03:11:33+08:00　|　id：`db6d9cad152815d7`
...
- AniketWathore (43 contributions)
...
Copy `window.BotConfig` + `chatbot-widget.js` and paste before ` `. Works on any site, accent/theme/greeting live via dashboard.
...
Paste before ` `. Widget stores `VISITOR_ID` + chat history in `localStorage`; greeting shows once.
...
- http://localhost:3000
- https://`
- https://github.com/AniketWathore/bolnee-chat.git
- https://openrouter.ai/api/v1
- https://your-domain/api/public/avatar/BOT_ID
- https://your-domain/api/public/chat/BOT_ID
- https://your-domain/chatbot-widget.js
- https://your-site.com`

## 导航

- 项目页：[[10-项目/github.com_845a2a4b]]
- 渠道页：[[50-渠道/hn_show]]
