---
type: "corpus"
item_id: "cb63ccdc353fef95"
title: "Show HN: Leo – a Markdown engineering process for AI coding agents"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49720815"
project_url: "https://github.com/alex-zaporozhan/leo"
author: "alex-zaporozhan"
published_at: "2026-09-16T00:47:27Z"
...
> [!info] 一句话导读
> A deterministic context-driven agentic SDLC framework for Cursor and Claude. 41 codified laws and 22 specialist roles to eliminate LLM hallucinations and contex…

> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49720815>
> 指标：点赞=2 · 评论=0 · engagement_velocity=2
> 作者：alex-zaporozhan　|　发布：2026-09-16T00:47:27Z
> 项目链接：<https://github.com/alex-zaporozhan/leo>
> 采集：2026-09-20T09:37:07+08:00　|　id：`cb63ccdc353fef95`

## 正文

# alex-zaporozhan/leo

A deterministic context-driven agentic SDLC framework for Cursor and Claude. 41 codified laws and 22 specialist roles to eliminate LLM hallucinations and context drift.
...
- alex-zaporozhan (3 contributions)
...
What it is · Why it exists · How it works · Proof at scale · Get started · The Manifesto · License
...
LEO has been directing real, shipped engineering work — not toy demos — across a multi-tenant healthcare SaaS, an AI training platform with RAG and executable agent graphs, and a public-facing marketing + CMS platform. See Proof at scale.
...
| **Agent-agnostic.** The constitution (`.cursorrules`) works as a system prompt anywhere; the full on-demand role library needs an agent with file-read/tool access (Cursor, Claude Code, Windsurf, Copilot Workspace agent mode) — see Compatibility | Tied to one vendor or one model |
...
Full map, jurisdictions, and hand-off contracts: `ARCHITECTURE.md`.

### 3. Forty-one laws, forged from incidents, not opinions

A sample — the full list lives in `.cursorrules`:
...
| **Status** | Shipped; source-available (PolyForm Shield), going public at github.com/alex-zaporozhan/medCore | Client engagement (NDA — architecture disclosed, business logic withheld) | Shipped |
...
1. **Copy the constitution.** Drop `.cursorrules` into the root of your project (or translate it to `CLAUDE.md`/`AGENTS.md` if your agent uses that convention).
...
**Is LEO "open source"?**
Not in the strict OSI sense — see License below. It is free to read, use, modify, and build on for essentially any purpose, including commercial software you build with it. What you may not do is repackage and sell LEO itself (or a directly competing framework built from it) as a product.

---

## License

**Source-available**, not OSI Open Source. SPDX identifier: `LicenseRef-PolyForm-Shield-1.0.0` — Shield is not (yet) on the official SPDX license list, unlike its Noncommercial/Strict/Small-Business siblings, hence the `LicenseRef-` prefix.
...
Full reasoning, a comparison against MIT / Apache-2.0 / CC-BY-NC-SA / PolyForm-Noncommercial, and how to request a commercial exception: **`LICENSING.md`**.
