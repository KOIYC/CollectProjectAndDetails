---
type: "corpus"
item_id: "45f43b02f8670b2c"
title: "Show HN: Thurbox – A tmux-based TUI and CLI for local AI agent orchestration"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49721082"
project_url: "https://github.com/Thurbeen/thurbox"
author: "magicleturcrttm"
published_at: "2026-09-16T01:25:49Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49721082>
> 指标：点赞=4 · 评论=0 · engagement_velocity=4
> 作者：magicleturcrttm　|　发布：2026-09-16T01:25:49Z
> 项目链接：<https://github.com/Thurbeen/thurbox>
> 采集：2026-09-20T09:37:07+08:00　|　id：`45f43b02f8670b2c`
...
- Open issues: 2
- License: MIT License
- Homepage: https://thurbox.thurbeen.eu/
- Default branch: main
- Created: 2026-02-12T15:47:33Z
...
- LeTuR (643 contributions)
- renovate[bot] (318 contributions)
- claude (30 contributions)
- TMSCH (9 contributions)
- claude-code-bot (4 contributions)
- mistral-vibe (1 contributions)
...
`THURBOX_INSTALL_DIR` env vars. Needs psmux
as the multiplexer.
...
Needs psmux as the multiplexer (installed
separately).
...
See Prerequisites for required tooling.
...
most polished of them, GitHub's Copilot App,
...
branch (`..HEAD`), a single commit, or the uncommitted changes; the
...
- **Inter-session messages** — an agent-neutral mailbox queue
...
- **Feature flags** — switch whole panels off in
...
See the full keybindings below.
...
`session delete ` is a **soft-delete**: by default it only
...
stays recoverable with `session restore ` (the TUI's `Ctrl+U`
...
`cron:" "`, or `at:<unix_millis>`. A `--session` makes it a
...
The built-in todo list (see Tasks for the model).
...
The inter-session message queue.
...
Manage opt-in add-ons (see Extensions for the model).
...
A bare ` ` resolves against the official source, **pinned to your
...
docs/CONFIG.md for every config file in one place.
...
- docs/ARCHITECTURE.md — Architectural
 decisions with rationale
- docs/FEATURES.md — Feature-level design
 choices (including agent definitions)
- docs/CONFIG.md — Every config file, env var,
...
6. Use conventional commits: `cog commit "message"`
...
# Now You Can Use — Web Platform Baseline Reference

## 关联链接

- https://github.com/Thurbeen/thurbox.git
- https://prod-backoffice.internal
- https://raw.githubusercontent.com/Thurbeen/thurbox/main/scripts/install.ps1
- https://raw.githubusercontent.com/Thurbeen/thurbox/main/scripts/install.sh
- https://thurbox.thurbeen.eu/

## 导航

- 项目页：[[10-项目/github.com_f5fac988]]
- 渠道页：[[50-渠道/hn_show]]
