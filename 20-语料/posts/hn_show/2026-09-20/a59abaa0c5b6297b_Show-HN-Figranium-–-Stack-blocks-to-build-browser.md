---
type: "corpus"
item_id: "a59abaa0c5b6297b"
title: "Show HN: Figranium – Stack blocks to build browser workflows and call via API"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49755752"
project_url: "https://github.com/figranium/figranium"
author: "asernasr"
published_at: "2026-09-18T15:25:28Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49755752>
> 指标：点赞=3 · 评论=0 · engagement_velocity=3
> 作者：asernasr　|　发布：2026-09-18T15:25:28Z
> 项目链接：<https://github.com/figranium/figranium>
> 采集：2026-09-20T09:36:38+08:00　|　id：`a59abaa0c5b6297b`
...
- Homepage: https://figranium.dev
- Default branch: main
- Created: 2025-12-25T01:42:51Z
...
- google-labs-jules[bot] (287 contributions)
- asernasr (212 contributions)
- claude (18 contributions)
- jsupa (4 contributions)
- dependabot[bot] (4 contributions)
- sun-andsky (3 contributions)
- CJWTRUST (1 contributions)
...
Figranium is an open-source, self-hosted alternative to Apify and SaaS cloud scrapers, built to turn browser workflows into instant API endpoints for developers, API pipelines, and low-code tools like n8n and Activepieces. Powered by a React/Vite control plane and an Express/Playwright runtime, it lets you visually build stealth browser tasks, pass dynamic variables during runtime, handle automatic proxy rotation, and stream structured results or CSV exports on your own infrastructure—delivering the instant API convenience of cloud actors without usage credits, rate caps, or third-party data hosting.
 ...
 Watch a video walkthrough of Figranium usage: demo.webm or demo.mp4
...
**Authentication:**
If enabled, provide the `x-api-key` header or `Authorization: Bearer `. For internal network use, this may be optional depending on your settings.
...
- http://user:pass@proxy1.example.com:8000
- https://figranium.dev
- https://github.com/figranium/figranium.git
- https://github.com/figranium`

## 导航

- 项目页：[[10-项目/github.com_b2cfe62e]]
- 渠道页：[[50-渠道/hn_show]]
