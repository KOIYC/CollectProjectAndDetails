---
type: "corpus"
item_id: "26cd9cc3b81b78b1"
title: "Show HN: Open-source tab and bookmark organizer for Chrome and Edge"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49722341"
project_url: "https://github.com/ringlochid/leotabs"
author: "ringlochid"
published_at: "2026-09-16T05:11:02Z"
captured_at: "2026-09-20T14:04:40+08:00"
lang: "en"
kind: "post"
topic: "AI 工具/Agent"
shard: "2026-09-20"
...
> [!info] 一句话导读
> Free, open-source tab and bookmark organizer for Chrome and Edge. Save project collections, search tabs, and switch between projects.

> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49722341>
> 指标：点赞=2 · 评论=2 · engagement_velocity=2
> 作者：ringlochid　|　发布：2026-09-16T05:11:02Z
> 项目链接：<https://github.com/ringlochid/leotabs>
> 采集：2026-09-20T14:04:40+08:00　|　id：`26cd9cc3b81b78b1`
...
- Homepage: https://ringlochid.me/leotabs/
- Default branch: main
- Created: 2026-09-06T08:59:30Z
...
Add to Chrome · User guide · Website · Contribute

LeoTabs library with open tabs on the left and coding collections, groups and notes on the right
...
- Save and reopen Chrome or Edge tabs
- Organize tabs and bookmarks by project
- Import OneTab, Toby or browser bookmarks
- Export tabs and saved links to Notion
...
1. Open LeoTabs in the Chrome Web Store and choose **Add to Chrome**. In Edge, allow extensions from other stores if prompted.
...
The store installation does not need Developer mode or Node.js. For a development copy, use Run locally.

Moving from an unpacked copy? Export **Settings → Export & import → Backup JSON** from that copy first. Install the store version, import the backup and check your collections before removing the old installation. Migration instructions.
...
Choose **Open** to add its saved pages to your browser, or **Switch** to make it the current collection in that window. Switch lets you decide what to save from the outgoing work; pinned tabs stay open. See Saving and switching.
...
In search, type `@` to choose a collection or `/` to find an action. Use the arrow keys and Enter to select a result. More search and shortcut options.

LeoTabs visual switcher showing grouped tab previews over the current web page
...
Your provider may charge for API usage. The AI guide covers setup, supported actions, data sent to the provider, and troubleshooting.
...
Exports are snapshots: later changes in LeoTabs or Notion do not sync. Follow the Notion guide for permissions, destination setup and resuming interrupted exports.
...
Backup and import guide · Privacy policy · Permissions

## Contribute

Bug reports, documentation improvements and focused pull requests are welcome. For a substantial feature or redesign, open an issue to discuss the user problem and proposed change first.
...
| --- | --- |
| extension/ui/ | Library, switcher, dialogs and styles |
| extension/lib/ | Storage, tab operations, grouping, search and integrations |
| extension/background.js | Browser events and background request handling |
| tests/ | Unit tests and browser regression scenarios |
| scripts/ | Build, validation, packaging and test runners |
| docs/ | User guides shared with the website |
| website/ | Website templates, styles and approved screenshots |
...
Run the relevant browser regression scenarios with `npm run test:browser -- `. Use `npm run test:browser -- --list` to see the available checks. Each scenario uses a disposable profile.

For documentation changes, run `npm run docs:check`. Build the shared online guides with `npm run site:build`, then run `npm run site:check`. See Contributing for development conventions and the website README for publication steps.
...
To create an installable ZIP, run `npm run package` after building. It writes `output/leotabs-.zip` with `manifest.json` at the archive root.

## Help

Start with the user guide or troubleshooting. For bugs, include your browser and LeoTabs versions, steps to reproduce, and what you expected to happen in an issue.

For private support or security reports, email support@ringlochid.me. Keep API keys, private browsing data and security-sensitive details out of public issues.

Maintained by Leo (ringlochid).

## License

Licensed under MPL-2.0. See NOTICE for third-party attribution.

# ForcePush: your commits vs your push-ups, settled daily

## 评论（2/2）

> **theycallmeritik** · 2026-09-16T05:26:48.000Z　
> Nice work! Does it support fuzzy searching across tabs and custom hotkeys, or is it purely UI-driven right now?

---

> **ringlochid** · 2026-09-16T07:34:33.000Z　
> yes, fuzzy searching is supported.

## 关联链接

- https://github.com/ringlochid/leotabs.git
- https://ringlochid.me/leotabs/

## 导航

- 项目页：[[10-项目/github.com_98170592]]
- 渠道页：[[50-渠道/hn_show]]
