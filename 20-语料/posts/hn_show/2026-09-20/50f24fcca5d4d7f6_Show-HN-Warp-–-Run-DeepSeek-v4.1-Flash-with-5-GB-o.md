...
tags:
  ...
  - story_49714036
  - show_hn
metrics: {"points": 13, "comments": 4, "engagement_velocity": 13}
comments_count: 4
comments_total: 4
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49714036>
> 指标：点赞=13 · 评论=4 · engagement_velocity=13
> 作者：marcobambini　|　发布：2026-09-15T15:28:23Z
> 项目链接：<https://github.com/sqliteai/warp>
> 采集：2026-09-21T21:59:54+08:00　|　id：`50f24fcca5d4d7f6`
...
- marcobambini (177 contributions)
- isenbek (3 contributions)
- pierre-x (2 contributions)
...
With aria2, which resumes and needs no GUI:
...
WARP is also an embeddable C library. The CLI and server both use the public API in src/waste.h. The inference path depends only on libc and pthreads. Text generation, memory planning, session persistence, and multimodal C examples are available in examples/README.md.
...
- docs/BACKENDS.md: CPU, SIMD, and Metal backends;
- docs/KDA.md: Kimi Delta Attention;
- docs/GATES.md: correctness and performance gates;
- docs/RESEARCH.md: current research directions.
- docs/TECHNICAL.md: detailed measurements and technical experiments.

## License

WARP is distributed under the permissive Apache 2.0 license, and **the project will always remain open source under a permissive license**. See LICENSE.
...
> **recentlypostedj** · 2026-09-15T15:49:01.000Z　
> What are the usecase that you can think of because 3.77 tok/s is actually to slow and better call a cloud API to do the task

---

> **Sev7eNup** · 2026-09-16T20:40:13.000Z　
> looks promising, will test it out.

---

> **zionsati** · 2026-09-17T07:04:00.000Z　
> Read the readme but still unclear - does this mean we can run DeepSeek v4.1 Flash on GPUs with 8GB VRAM?

---

> **cyanydeez** · 2026-09-15T22:54:11.000Z　
> Any well defined problem would probably be of use. How often anyone comes across these without other help is anyones guess.
