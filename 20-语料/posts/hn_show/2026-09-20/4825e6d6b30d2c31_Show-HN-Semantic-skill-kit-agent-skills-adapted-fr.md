---
type: "corpus"
item_id: "4825e6d6b30d2c31"
title: "Show HN: Semantic-skill-kit:agent skills adapted from Google Modern Web Guidance"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49758031"
project_url: "https://github.com/ulrischa/semantic-skill-kit"
author: "ulrischa"
published_at: "2026-09-18T18:08:38Z"
captured_at: "2026-09-20T09:36:37+08:00"
lang: "en"
kind: "post"
topic: "AI 工具/Agent"
shard: "2026-09-20"
...
> [!info] 一句话导读
> ulrischa/semantic-skill-kit

> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49758031>
> 指标：点赞=2 · 评论=0 · engagement_velocity=2
> 作者：ulrischa　|　发布：2026-09-18T18:08:38Z
> 项目链接：<https://github.com/ulrischa/semantic-skill-kit>
> 采集：2026-09-20T09:36:37+08:00　|　id：`4825e6d6b30d2c31`
...
| Command | Purpose |
|---|---|
| `init ` | Create an independent knowledge project |
...
| `retrieve ` | Print one complete guide |
| `status` | Inspect index freshness and counts |
| `model` | Download/warm the configured model |
| `export ` | Export a reusable skill snapshot |

All except `init` support `--project ` (default: current directory). `search` also supports `--top-k` and `--threshold`. `--offline` requires a prepared model cache. Output is JSON or document text on stdout, diagnostics on stderr.
...
# Signal | Audience analytics for studios, publishers, and PR teams | Skip The Critics

## 关联链接

- https://api.openai.com/v1
- https://github.com/ulrischa/semantic-skill-kit.git

## 导航

- 项目页：[[10-项目/github.com_1932c406]]
- 渠道页：[[50-渠道/hn_show]]
