---
type: "corpus"
item_id: "51cb733cbbea3870"
title: "Show HN: Continuity – project state your AI sessions can't silently contradict"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49750016"
project_url: "https://github.com/vikcena01/ai-continuity-plugin"
author: "vikcena01"
published_at: "2026-09-18T03:56:51Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49750016>
> 指标：点赞=3 · 评论=0 · engagement_velocity=3
> 作者：vikcena01　|　发布：2026-09-18T03:56:51Z
> 项目链接：<https://github.com/vikcena01/ai-continuity-plugin>
> 采集：2026-09-20T09:36:42+08:00　|　id：`51cb733cbbea3870`

## 正文

# vikcena01/ai-continuity-plugin

Durable project state across AI sessions — decisions, constraints, and rejected paths, versioned in git. Not a memory tool.
...
- vikcena01 (119 contributions)

---

## README

 Resume any AI session without losing your decisions, constraints, or direction.
...
- **Two storage modes, one API.** *Repo mode* (` /.continuity/`, found by walking up from the working dir) suits editor/agent tools with a project cwd like Claude Code. *Central mode* (`~/.continuity/projects/ /`, named projects) suits tools with no project cwd like **Claude Desktop** — you just refer to a project by name.
...
See `DESIGN.md` for the full architecture and `poc/` for the validation that motivated it.
...
MIT — see `LICENSE`. Copyright (c) 2026 Vikash.

# Free Tournament Bracket Maker & Generator | SnapBracket

## 导航

- 项目页：[[10-项目/github.com_c10abe1c]]
- 渠道页：[[50-渠道/hn_show]]
