...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49757048>
> 指标：点赞=2 · 评论=0 · engagement_velocity=2
> 作者：b1shp　|　发布：2026-09-18T16:54:09Z
> 项目链接：<https://github.com/colinedwardwood/sagemcom-docsis-exporter>
> 采集：2026-09-20T09:36:37+08:00　|　id：`461fd1f6c02cfe14`

## 正文

# colinedwardwood/sagemcom-docsis-exporter

Prometheus exporter for Sagemcom F3896/FAST3896S DOCSIS cable gateways (Cogeco, Breezeline, and likely other ISPs)
...
- colinedwardwood (6 contributions)
...
`METRICS_AND_API.md`. Machine-readable transport/RPC specs:
`openapi.yaml`, `openrpc.json`.
...
Point Prometheus or Grafana Alloy at `http://:9488/metrics`.
An Alloy scrape fragment lives in `alloy/sagemcom-docsis.alloy`
...
before as `modem-log: `. Under systemd these land in journald, and Alloy ships the
...
`sagemcom-docsis-modem.shared.json`
...
- http://127.0.0.1:9488/healthz
- http://127.0.0.1:9488/metrics
- http://:9488/metrics`.

## 导航

- 项目页：[[10-项目/github.com_77fb0e5c]]
- 渠道页：[[50-渠道/hn_show]]
