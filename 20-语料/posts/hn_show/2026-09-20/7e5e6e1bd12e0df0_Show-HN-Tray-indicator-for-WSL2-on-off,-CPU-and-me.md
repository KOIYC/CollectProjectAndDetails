...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49724577>
> 指标：点赞=2 · 评论=0 · engagement_velocity=2
> 作者：bpacholek　|　发布：2026-09-16T10:48:15Z
> 项目链接：<https://github.com/ideaconnect/wsl-tray>
> 采集：2026-09-20T09:37:04+08:00　|　id：`7e5e6e1bd12e0df0`

## 正文

# ideaconnect/wsl-tray

Tray indicator for WSL2: on/off, CPU and memory, one-click shutdown
...
Tray icon while WSL2 is running
...
opens buymeacoffee.com/idct in your browser.
...
This is a plain `HKEY_CURRENT_USER\Software\ \ ` key, which
...
(`%LOCALAPPDATA%\Packages\ \SystemAppData\Helium`), so the
...
For comparison, the original Go version
...
unless asked for with `-- --ignored `: `dialog_roundtrip` drives the
...
BSD 3-Clause, see LICENSE. The Tux glyph is the "linux" icon from
Font Awesome Free, CC BY 4.0; see
THIRD_PARTY_NOTICES.md.

# Sunred — The web, back in your hands.

## 导航

- 项目页：[[10-项目/github.com_cbaab7c0]]
- 渠道页：[[50-渠道/hn_show]]
