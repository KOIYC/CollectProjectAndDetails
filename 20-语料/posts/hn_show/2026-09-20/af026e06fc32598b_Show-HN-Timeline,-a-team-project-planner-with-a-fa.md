---
type: "corpus"
item_id: "af026e06fc32598b"
title: "Show HN: Timeline, a team project planner with a fast canvas Gantt view"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49757352"
project_url: "https://github.com/vakahnke/Timeline"
author: "vakahnke"
published_at: "2026-09-18T17:16:02Z"
captured_at: "2026-09-20T14:02:18+08:00"
lang: "en"
kind: "post"
topic: "AI 工具/Agent"
shard: "2026-09-20"
...
tags:
  ...
  - story_49757352
  - show_hn
metrics: {"points": 2, "comments": 5, "engagement_velocity": 2}
comments_count: 5
comments_total: 5
...
> [!info] 一句话导读
> Plan it once. Do it. Keep the plan that worked. A self-hosted project planner with a canvas Gantt timeline you can grab, reusable plan templates, and one-click …

> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49757352>
> 指标：点赞=2 · 评论=5 · engagement_velocity=2
> 作者：vakahnke　|　发布：2026-09-18T17:16:02Z
> 项目链接：<https://github.com/vakahnke/Timeline>
> 采集：2026-09-20T14:02:18+08:00　|　id：`af026e06fc32598b`

## 正文

# vakahnke/Timeline

Plan it once. Do it. Keep the plan that worked. A self-hosted project planner with a canvas Gantt timeline you can grab, reusable plan templates, and one-click status slides (editable PowerPoint). Django + React, Apache-2.0.
...
- Homepage: https://web-production-28ba24.up.railway.app
- Default branch: main
- Created: 2026-03-08T03:06:50Z
...
**Try the live demo** (sign in as
`demo` / `demo12345`) · Run it in two minutes ·
Templates ·
The status report ·
User guide · Architecture

Zooming the timeline, moving an event while its dependency arrows follow, undo, the board, and the status report

Free and open source under the Apache 2.0 license: use it, modify it, and redistribute
...
A template's page: the plan, its track record and comments
...
The status report print tool: the page on the right, what it shows on the left
...
Try it on the live demo: open **Startup MVP: Idea to Launch** and
click **Status report**. Details are in the user guide and
the design doc.
...
- User Guide: accounts, projects, the timeline (gestures
 and shortcuts), templates, teams, roles, the admin console
- Architecture: tenancy model, data model, auth flow,
 frontend design, request flow
- Deployment: production stack, environment variables,
 nginx and gunicorn, CI
- AWS Deployment: a worked example on EC2 with
 Terraform, Cloudflare, and HTTPS
- Railway demo: the single-container image behind
 the public demo, with a scheduled reset
- Design docs: how larger features are designed before they are
 built, plus the designs for the board and
 permissions
...
Deployment covers the environment variables, TLS options,
and backups. AWS Deployment is a complete worked
...
| GET/POST/PATCH/DELETE | `/api/projects/`, `/api/projects/ /` | your projects |
| GET/POST/PATCH/DELETE | `/api/projects/ /members/` | members (owner only) |
| GET/POST/PATCH/DELETE | `/api/projects/ /events/`, `/api/projects/ /categories/` | viewers read, editors write |
| POST | `/api/projects/ /events/bulk/` | bulk-create events |
| GET/POST/PATCH/DELETE | `/api/templates/`, `/api/templates/ /`, `…/instantiate/` | templates and the template library |
| POST/DELETE, GET/POST | `/api/templates/ /vote/`, `…/comments/`, `…/fork/`, `…/unpublish/`, `…/report/` | votes, comments, copies, moderation |
| GET/POST/PATCH/DELETE | `/api/teams/`, `/api/teams/ /members/` | reusable teams |
| POST | `/api/projects/ /add-team/` | add a team at a role (owner only) |
...
design docs README describes the process: a short
...
Apache License 2.0. See LICENSE and NOTICE. Third-party
dependencies and their licenses are listed in
THIRD_PARTY_LICENSES.md.

## 评论（5/5）

> **vakahnke** · 2026-09-18T18:07:14.000Z　
...
> **vakahnke** · 2026-09-19T11:41:53.000Z　
> Live demo now up: https://web-production-28ba24.up.railway.app,
> log in as demo / demo12345. Resets every six hours.

---

> **veexx103** · 2026-09-19T13:19:23.000Z　
> The name of this project is too generic; it lacks distinctiveness.

---

> **vakahnke** · 2026-09-19T13:42:41.000Z　
> You're not wrong. What do you recommend? what was the first thing that popped into your head?

---

> **veexx103** · 2026-09-19T14:28:30.000Z　
> No, I'm also struggling with the naming issue.
...
- https://github.com/vakahnke/Timeline.git
- https://web-production-28ba24.up.railway.app
- https://web-production-28ba24.up.railway.app**

## 导航

- 项目页：[[10-项目/github.com_903da69a]]
- 渠道页：[[50-渠道/hn_show]]
