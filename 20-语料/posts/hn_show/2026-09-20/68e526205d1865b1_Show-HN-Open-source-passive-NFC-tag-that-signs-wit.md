---
type: "corpus"
item_id: "68e526205d1865b1"
title: "Show HN: Open-source passive NFC tag that signs with ECDSA, verified on-chain"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49712073"
project_url: "https://github.com/mwbpNFTechnology/toluTag"
author: "boust16"
published_at: "2026-09-15T13:17:04Z"
captured_at: "2026-09-20T09:37:17+08:00"
lang: "en"
kind: "post"
topic: "开发者工具"
shard: "2026-09-20"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49712073>
> 指标：点赞=9 · 评论=0 · engagement_velocity=9
> 作者：boust16　|　发布：2026-09-15T13:17:04Z
> 项目链接：<https://github.com/mwbpNFTechnology/toluTag>
> 采集：2026-09-20T09:37:17+08:00　|　id：`68e526205d1865b1`
...
|---|---|---|---|
| `Software/IOS` | iOS 26, SwiftUI | CoreNFC (`NFCTagReaderSession`, ISO 7816) | Field app: provision, inspect and sign with a tag from a phone |
| `Software/Java` | Java 21, CLI | PC/SC (`javax.smartcardio`) | Desktop/bench tooling: batch provisioning, deep inspection, encoder self-tests |
...
**tolu.network** and experiment with a real tag.
...
toluTag rigid PCB and flex board
...
**0xLimited** is the first way to put
...
- **EIP-191** (`personal_sign`), including the toluTag phrase template
 ` _ _ `, where `address` is the chip's own address or a
...
described under Shape the tag however you need,
...
via the Portal platform.
 ...
 toluTag is part of the Portal platform, built by mwbp.io.

# Briefing Service: AI-enabled data services for e-ink readers and agents

## 导航

- 项目页：[[10-项目/github.com_b6e3b337]]
- 渠道页：[[50-渠道/hn_show]]
