---
type: "corpus"
item_id: "b77b812b60eccc32"
title: "Show HN: Pi-box: Pi coding agent running inside a VM inside WASM inside Electron"
source: "hn_show"
source_name: "HN Show HN"
url: "https://news.ycombinator.com/item?id=49706083"
project_url: "https://github.com/deepclause/pi-box"
author: "schmuhblaster"
published_at: "2026-09-15T00:21:19Z"
...
> [!meta]- 语料信息（点开展开）
> 来源：HN Show HN（post）
> 原帖：<https://news.ycombinator.com/item?id=49706083>
> 指标：点赞=3 · 评论=0 · engagement_velocity=3
> 作者：schmuhblaster　|　发布：2026-09-15T00:21:19Z
> 项目链接：<https://github.com/deepclause/pi-box>
> 采集：2026-09-20T09:37:33+08:00　|　id：`b77b812b60eccc32`
...
- **macOS (Apple Silicon):** pi-box-0.4.0-arm64.dmg
- **macOS (Intel):** pi-box-0.4.0.dmg
- **Linux (AppImage):** pi-box-0.4.0.AppImage
- **Linux (deb):** pi-box_0.4.0_amd64.deb
- **Windows (installer):** pi-box.Setup.0.4.0.exe
- **Windows (portable):** pi-box.0.4.0.exe
...
- **Persistent root filesystem** — a per-workspace ext4 overlay (guest-root changes
 ...
 overlay image lives at ` /.agentvm/upper.img`.
...
- **`WorkspaceStore`** persists workspaces to ` /workspaces.json`,
...
- With **`persistentRoot`** enabled, AgentVM mounts an ext4-overlay root backed
 by ` /.agentvm/upper.img` before the startup script runs, so
...
- Persistence uses a 512 MB sparse ext4 overlay image per workspace
 (` /.agentvm/upper.img`); the first boot of a workspace is slower
 because the guest formats it with `mkfs.ext4`.

## 导航

- 项目页：[[10-项目/github.com_d020d4c5]]
- 渠道页：[[50-渠道/hn_show]]
