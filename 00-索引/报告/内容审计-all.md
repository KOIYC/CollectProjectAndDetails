...
type: "report"
title: "内容质量审计 all"
updated: "2026-09-21T09:57:11+08:00"
tags:
  - 索引
  - 审计
  - 内容质量
...
> 生成 2026-09-21T09:57:11+08:00 · 审计器 `tools/kb_content_audit.py`

- 唯一条目 **1615** · 可用（无致命缺陷、且相关）**1413** (87%)
- 不可用于深度分析（空/过短/摘要残文）**106** (7%)
- 相关性可疑（无项目信号/资源清单/泛媒体/大厂）**117** (7%)
- 正文长度 中位 **2011** · 均值 4883 · 空正文 52 · <200 字符 114
...
| reddit | 项目讨论 | 244 | 149 | 25 | 89 | 6 | 3 | 3 | 0 | 0 | 0 | 0 | 0 | 877 |
...
- `body_format`：markdown=1043, text=572
