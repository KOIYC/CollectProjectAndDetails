...
type: "report"
title: "内容质量审计 all"
updated: "2026-09-22T14:00:14+08:00"
tags:
  - 索引
  - 审计
  - 内容质量
...
> 生成 2026-09-22T14:00:14+08:00 · 审计器 `tools/kb_content_audit.py`

- 唯一条目 **1753** · 可用（无致命缺陷、且相关）**1541** (88%)
- 不可用于深度分析（空/过短/摘要残文）**101** (6%)
- 相关性可疑（无项目信号/资源清单/泛媒体/大厂）**133** (8%)
- 正文长度 中位 **1938** · 均值 4793 · 空正文 41 · <200 字符 110
- 历史深度（**内容发布时间轴**，趋势分析看这个）：近 90 天 **1305 条**，更早 376 条，无发布时间 72 条（最早 ['2014-04-04']）
- 采集时间轴：`captured_at` 覆盖 3 天 (2026-09-20, 2026-09-21, 2026-09-22)
- 语种：en=1652, zh=101
- kind：post=1599, project=134, method=17, person=3
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| hn_show | 原文=项目发布帖 | 1080 | 1008 | 72 | 0 | 0 | 0 | 17 | 24 | 17 | 0 | 0 | 0 | 4035 |
| reddit | 项目讨论 | 270 | 166 | 27 | 99 | 7 | 3 | 3 | 0 | 0 | 0 | 0 | 0 | 815 |
| producthunt | 项目发布 | 91 | 90 | 0 | 1 | 0 | 1 | 0 | 0 | 91 | 0 | 0 | 91 | 330 |
| betalist | 预发布项目 | 67 | 67 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 1 | 67 | 67 | 1593 |
| github_new | 项目仓库 | 63 | 46 | 2 | 15 | 11 | 0 | 2 | 0 | 18 | 0 | 0 | 0 | 5090 |
| indiehackers | 项目库 | 63 | 63 | 0 | 0 | 0 | 0 | 0 | 4 | 0 | 63 | 63 | 63 | 2341 |
| v2ex | 中文讨论 | 45 | 37 | 0 | 8 | 5 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 1137 |
| bilibili | 中文视频（仅元数据） | 43 | 41 | 0 | 2 | 2 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 109 |
...
- `published_at` 缺失 **72** · 格式未规范化 **5**
- `author` 缺失 **152** · `metrics` 全空 **246**
- `body_format`：markdown=1102, text=651
